                        ...
                        <div className="space-y-6">
                            <div className="flex items-center gap-6 group">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:ashabhi1234567@gmail.com" className="text-lg text-text-primary hover:text-accent-teal transition-colors font-bold font-display">
                                        ashabhi1234567@gmail.com
                                    </a>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-6 group">
                                ...
                                <div>
                                    ...
                                    <a
                                        href="https://www.linkedin.com/in/abhishek-singh089/"
                                        target="_blank"
                                        rel="noopener noreferrer"
                            ...
                            <div className="flex items-center gap-6 group">
                                ...
                                <div>
                                    ...
                                    <a
                                        href="https://github.com/abhishek11x"
                                        target="_blank"
                                        rel="noopener noreferrer"
